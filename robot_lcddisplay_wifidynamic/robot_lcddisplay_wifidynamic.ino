...
const int ledPin2 = 0;  // LED connected to GPIO 27
...
void setup() {
  ...
  String savedSSID = preferences.getString("SSID","ESIL_UG_2G");
  String savedPassword = preferences.getString("Password","Hild#098");
